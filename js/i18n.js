(function (C) {
  ...
  var EN = {
    ...
    // ---- range, transposing, MIDI import
    'Fuera del rango de la ocarina ({range})': 'Out of the ocarina’s range ({range})',
    '1 nota está fuera del rango de la ocarina ({range}) y no se podrá tocar.': '1 note is out of the ocarina’s range ({range}) and cannot be played.',
    '{n} notas están fuera del rango de la ocarina ({range}) y no se podrán tocar.': '{n} notes are out of the ocarina’s range ({range}) and cannot be played.',
    'Transportar…': 'Transpose…',
    'Transportar': 'Transpose',
    'Subir o bajar toda la canción, para adaptarla a tu ocarina': 'Raise or lower the whole song, to fit your ocarina',
    'Transportar la canción': 'Transpose the song',
    'Sube o baja todas las notas el mismo número de semitonos. Se puede deshacer.': 'Raises or lowers every note by the same number of semitones. It can be undone.',
    'octava': 'octave',
    'Sin cambios': 'No change',
    'Escribir con': 'Write with',
    'La canción todavía no tiene notas.': 'The song has no notes yet.',
    '1 nota se saldría de las octavas de la página. Elige un desplazamiento menor.': '1 note would fall outside the octaves the page has. Pick a smaller shift.',
    '{n} notas se saldrían de las octavas de la página. Elige un desplazamiento menor.': '{n} notes would fall outside the octaves the page has. Pick a smaller shift.',
    '1 de {total} notas queda fuera del rango de la ocarina ({range}).': '1 of {total} notes is out of the ocarina’s range ({range}).',
    '{n} de {total} notas quedan fuera del rango de la ocarina ({range}).': '{n} of {total} notes are out of the ocarina’s range ({range}).',
    'Todas las notas caben en la ocarina ({range}).': 'Every note fits the ocarina ({range}).',
    'Tonalidad: {key}': 'Key: {key}',
    'Canción transportada. {n} notas siguen fuera del rango de la ocarina.': 'Song transposed. {n} notes are still out of the ocarina’s range.',
    'Canción transportada.': 'Song transposed.',
    'Importar MIDI': 'Import MIDI',
    'Crear una canción a partir de un archivo MIDI': 'Make a song from a MIDI file',
    'Canción importada': 'Imported song',
    'Ese archivo no parece un MIDI.': 'That file does not look like a MIDI.',
    'Este MIDI usa un reloj por fotogramas, que no se puede importar.': 'This MIDI is timed in frames, which cannot be imported.',
    'Ese MIDI no tiene notas que importar.': 'That MIDI has no notes to import.',
    'El archivo es demasiado grande para ser un MIDI de una melodía.': 'The file is too big to be a single-melody MIDI.',
    'No se pudo leer el archivo MIDI.': 'The MIDI file could not be read.',
    'Pista {n}': 'Track {n}',
    'canal {n}': 'channel {n}',
    'Pista': 'Track',
    '{n} notas y silencios en {lines} líneas.': '{n} notes and rests in {lines} lines.',
    'Tempo {bpm} · compás {meter}.': 'Tempo {bpm} · time signature {meter}.',
    '{n} octavas': '{n} octaves',
    'Las notas se han subido {amount} para acercarlas a la ocarina.': 'The notes were raised {amount} to bring them closer to the ocarina.',
    'Las notas se han bajado {amount} para acercarlas a la ocarina.': 'The notes were lowered {amount} to bring them closer to the ocarina.',
    '{n} notas quedan fuera del rango de la ocarina ({range}); podrás transportarlas en el editor.': '{n} notes are out of the ocarina’s range ({range}); you can transpose them in the editor.',
    '{n} notas muy largas se han partido en varias.': '{n} very long notes were split into several.',
    'MIDI importado: revisa la canción y pulsa Listo para guardarla.': 'MIDI imported: check the song and press Done to save it.',
    'Importar un MIDI': 'Import a MIDI',
    'Elige la pista que lleva la melodía.': 'Pick the track that carries the melody.',
    'Esta es la melodía que se ha encontrado.': 'This is the melody that was found.',
    'Mover las octavas para que quepan en la ocarina': 'Move the octaves so it fits the ocarina',
    'Abrir en el editor': 'Open in the editor',

    // ---- audio import
    'Importar archivo': 'Import file',
    'Crear una canción a partir de un archivo MIDI o de audio': 'Make a song from a MIDI or audio file',
    'No se pudo leer ese archivo como audio.': 'That file could not be read as audio.',
    'No se ha encontrado ninguna nota en ese audio. ¿Hay una melodía clara?': 'No notes were found in that audio. Is there a clear melody?',
    'El archivo es demasiado grande.': 'The file is too big.',
    'Este navegador no puede leer audio.': 'This browser cannot read audio.',
    'No se pudo analizar el audio.': 'The audio could not be analysed.',
    'Analizando el audio…': 'Analysing the audio…',
    'Importar desde un audio': 'Import from audio',
    'Solo sirve para una única melodía.': 'It only works for a single melody.',
    'El audio debe tener un solo instrumento, voz o silbido, sin nada más sonando. Si hay más de un instrumento o sonido a la vez (acompañamiento, bajo, batería, voces), el resultado será basura.': 'The audio must have one instrument, voice or whistle, with nothing else sounding. If more than one instrument or sound plays at once (accompaniment, bass, drums, voices), the result will be garbage.',
    'Tempo (BPM)': 'Tempo (BPM)',
    'Sensibilidad': 'Sensitivity',
    'Normal': 'Normal',
    'Detallada (notas más cortas)': 'Detailed (shorter notes)',
    'Simplificada (ignora las notas breves)': 'Simplified (ignores brief notes)',
    'La mitad del tempo': 'Half the tempo',
    'El doble del tempo': 'Double the tempo',
    '{n} notas detectadas en {seconds} s.': '{n} notes detected in {seconds} s.',
    'Este audio parece tener varios sonidos a la vez.': 'This audio seems to have several sounds at once.',
    'Solo el {p} % del sonido tiene una nota clara. Es casi seguro que el resultado sea inservible.': 'Only {p} % of the sound has a clear note. The result is almost certainly useless.',
    'El {p} % del sonido tiene una nota clara: parece una sola melodía. Revisa el resultado en el editor.': '{p} % of the sound has a clear note: it looks like a single melody. Check the result in the editor.',
    'Audio importado: revisa la canción y pulsa Listo para guardarla.': 'Audio imported: check the song and press Done to save it.',
    'Solo se han analizado los primeros {n} minutos.': 'Only the first {n} minutes were analysed.',

    'Las notas apagadas quedan fuera del rango de la ocarina ({range}).': 'The faded notes are outside the ocarina’s range ({range}).',
    ...
    'Ocarina Songbook se ha instalado.': 'Ocarina Songbook was installed.',
    'Sin conexión: la página sigue funcionando con las canciones que ya tiene guardadas.': 'No connection: the page keeps working with the songs it already has.',
    'De nuevo con conexión.': 'Back online.',
    ...
    'La partitura como imagen: un pentagrama por cada línea de la canción, con las duraciones dibujadas.': 'The score as an image: one staff for every line of the song, with the note values drawn.',
    'Nombres': 'Names',
    'El nombre de cada nota bajo el pentagrama.': 'The name of each note under the staff.',
    'El dibujo de la ocarina bajo cada nota. Una digitación sin terminar sale con el nombre de la nota.': 'A drawing of the ocarina under each note. A fingering that is not finished shows the name of the note.',
    'El dibujo de la ocarina y el nombre de la nota.': 'The drawing of the ocarina and the name of the note.',
    'Elige qué se escribe bajo cada nota. Las duraciones (negras, corcheas, blancas…) se dibujan siempre.': 'Choose what is written under each note. The note values (quarter, eighth, half notes…) are always drawn.',
    'Bajo cada nota': 'Under each note',
    'Crear imagen': 'Create image',
    'Atrás': 'Back',
    'La canción todavía no tiene notas que dibujar.': 'The song has no notes to draw yet.',
    'La partitura es demasiado grande para crear la imagen en este dispositivo.': 'The score is too big to make the image on this device.',
    'Agujero tapado': 'Covered hole',
    'Agujero abierto': 'Open hole',

    // ---- metronome
    'Detector de notas': 'Note detector',
    'Activa el micrófono y toca: la página te dice qué nota oye y si está afinada. Elige una nota para practicarla y te dirá si vas por encima o por debajo.': 'Turn the microphone on and play: the page tells you which note it hears and whether it is in tune. Pick a note to practise and it tells you whether you are above or below it.',
    'Nota a practicar': 'Note to practise',
    'Cualquier nota': 'Any note',
    'Toca {note}…': 'Play {note}…',
    '¡Bien! Es la nota': 'Good! That is the note',
    'Es la nota, un poco alta (+{cents} cents)': 'That is the note, a little sharp (+{cents} cents)',
    'Es la nota, un poco baja ({cents} cents)': 'That is the note, a little flat ({cents} cents)',
    'Por encima de {note}: {distance}': 'Above {note}: {distance}',
    'Por debajo de {note}: {distance}': 'Below {note}: {distance}',
    '{n} semitono': '{n} semitone',
    '{n} semitonos': '{n} semitones',
    'una octava': 'an octave',
    'El sonido no se graba ni sale de tu equipo. Si suena el metrónomo o una canción por los altavoces, el micrófono la oirá: usa auriculares.': 'The sound is not recorded and never leaves your device. If the metronome or a song plays through the speakers, the microphone will hear it: use headphones.',
    'Activar el micrófono': 'Turn the microphone on',
    'Apagar el micrófono': 'Turn the microphone off',
    'Esperando el permiso del micrófono…': 'Waiting for the microphone permission…',
    'Toca una nota…': 'Play a note…',
    'En afinación': 'In tune',
    'Un poco alta (+{cents} cents)': 'A little sharp (+{cents} cents)',
    'Un poco baja ({cents} cents)': 'A little flat ({cents} cents)',
    'Fuera de las octavas de la ocarina': 'Outside the ocarina’s octaves',
    'Afinación': 'Tuning',
    'No hay permiso para usar el micrófono. Permítelo en el navegador y vuelve a intentarlo.': 'There is no permission to use the microphone. Allow it in the browser and try again.',
    'No se ha encontrado ningún micrófono.': 'No microphone was found.',
    'Este navegador no puede usar el micrófono aquí. Hace falta abrir la página desde una dirección segura (https).': 'This browser cannot use the microphone here. The page has to be opened from a secure address (https).',
